...
my_module.hello_world("Vladimir")  # Вызовите функцию hello_world из модуля my_module
...
print(hello_world("Vova"))    # Функция hello_world должна вызываться без указания модуля )